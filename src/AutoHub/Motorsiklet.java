...
public class Motorsiklet extends TeknikOzellikler{

    List<TeknikOzellikler> motorsiklet = new ArrayList<>();

    public Motorsiklet(int ilanNo, String marka, String model, String seri
